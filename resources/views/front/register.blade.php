...
@section('content')
    <section class="relative pt-32 pb-36 bg-gradient-gray2 overflow-hidden">
        <img class="absolute top-1/2 transform -translate-y-1/2 left-0" src="{{ $frontSetting->register_background_url }}"
            alt="">
                ...
                <div class="w-full md:w-1/2 p-6">
                    <div class="md:max-w-xl">
                        ...
                        <div class="register-div">
                            ...
                            <div class="text-center items-center form-group w-auto p-1.5">
                                <a class="text-gray-900 hover:text-gray-700 text-sm text-danger"
