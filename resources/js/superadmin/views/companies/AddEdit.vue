<template>
    <a-drawer :title="pageTitle" :width="drawerWidth" :open="visible" :body-style="{ paddingBottom: '80px' }"
        ...
        <a-form layout="vertical">
            ...
            <a-row :gutter="16">
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-form-item :label="$t('user.email')" name="user_email"
                        :help="rules.user_email ? rules.user_email.message : null"
                        :validateStatus="rules.user_email ? 'error' : null" class="required">
                        <a-input v-model:value="formData.user_email" :placeholder="$t('common.placeholder_default_text', [$t('user.email')])
                            " />
                    </a-form-item>
                </a-col>
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-form-item :label="$t('user.password')" name="user_password"
                        :help="rules.user_password ? rules.user_password.message : null"
                        :validateStatus="rules.user_password ? 'error' : null" class="required">
                        <a-input-password v-model:value="formData.user_password" :placeholder="$t('common.placeholder_default_text', [
                            $t('user.password'),
                        ])
                            " />
