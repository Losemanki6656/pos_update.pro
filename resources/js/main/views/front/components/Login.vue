<template>
    ...
    <a-modal v-model:open="visible" centered :footer="null" :title="null" :width="450" :closable="false"
        ...
        <div v-else>
            ...
            <a-form v-else layout="vertical" class="mt-30">
                ...
                <a-form-item :label="$t('user.phone')" name="phone" :help="rules.phone ? rules.phone.message : null"
                    ...
                    <a-input v-model:value="signupCredentials.phone" @pressEnter="onSignup" :placeholder="$t('common.placeholder_default_text', [$t('user.phone')])
                        ">
                        <template #prefix>
                            <PhoneOutlined />
                        </template>
