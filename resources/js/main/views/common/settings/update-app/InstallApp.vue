<template>
    ...
    <a-modal
        v-model:open="installUpdateModalVisible"
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const install = (moduleName) => {
            ...
            axiosAdmin
                .post(getUrlByAppType("update-app/update"), postArray)
                .then((response) => {
                    ...
                    // Extracting Zip File
                    axiosAdmin
                        .post(getUrlByAppType("update-app/extract"), newPostArray)
        ...
        const setDownloadPercentage = () => {
            axiosAdmin(getUrlByAppType("update-app/download-percentage")).then(
                (response) => {
